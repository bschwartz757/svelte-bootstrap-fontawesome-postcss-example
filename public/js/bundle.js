var app = (function () {
  ...
  `)
	...
	function fade_1(node, { delay = 0, duration = 400 }) {
	...
	function create_if_block_1(component, state) {
		var div, h1, text_value = state.current[0], text, div_transition, introing, outroing;
	...
	function create_if_block_2(component, state) {
		var div, span, text_value = state.current[0].temp.f, text, div_transition, text_2, sup, text_4, div_1, span_1, text_6, span_2, text_7_value = state.current[0].conditions.description, text_7, text_8, span_3, text_9_value = state.current[0].humidity, text_9, text_10, introing, outroing;
	...
	function fade_1$1(node, { delay = 0, duration = 400 }) {
	  const o = +getComputedStyle(node).opacity;
	...
	function create_if_block_1$1(component, state) {
		var div, div_1, h1, text_value = state.forecast[0], text, div_transition, text_3, style, introing, outroing;
	...
	function add_css$2() {
		...
		style.textContent = ".weather-app-card.svelte-1j9k5mo{color:white;background-color:rgba(74, 144, 226,\n    0.75);box-shadow:0 0 .75rem rgba(0, 0, 0, 0.5);padding:0 0}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
		appendNode(style, document.head);
	}
